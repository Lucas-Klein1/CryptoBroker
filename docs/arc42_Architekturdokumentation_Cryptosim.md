...
| Begriff | Definition |
|---------|-----------|
| **Coin / Cryptocurrency** | Digitale Währung (z.B. Bitcoin, Ethereum) |
| **Trade** | Kauf (BUY) oder Verkauf (SELL) einer Kryptowährung |
| **Portfolio** | Gesamtheit aller gehaltenen Coins eines Benutzers |
| **Position** | Anzahl der gehaltenen Coins einer bestimmten Währung |
| **Transaction** | Einzelner Trade (BUY oder SELL) mit Zeitstempel |
| **Market Cap** | Gesamtwert aller existierenden Coins einer Währung |
| **bcrypt** | Password-Hashing-Algorithmus mit Salt und Rounds |
| **Inkrementelle Synchronisation** | Nur neue/fehlende Daten abrufen, Duplikate vermeiden |
| **CoinGecko** | Externe API für Kryptowährungsdaten |
| **Session** | Authentifizierte Benutzersitzung (speichert acc_id) |

---

## 12. Anhänge

### 12.1 draw.io Diagramme

Alle Architektur-Diagramme sind als **draw.io** Dateien verfügbar:

| Datei | Typ | Beschreibung |
|-------|-----|-------------|
| `uml/01_component_diagram.drawio` | Component | Komponenten & Abhängigkeiten |
| `uml/02_sequence_login.drawio` | Sequence | Login & Authentifizierung |
| `uml/03_sequence_trade.drawio` | Sequence | Trade-Ausführung |
| `uml/04_deployment_diagram.drawio` | Deployment | Systemverteilung |
| `uml/05_package_diagram.drawio` | Package | 3-Schichten-Architektur |

**Öffnen & Exportieren:**
1. **Online:** https://app.diagrams.net/ → File → Open from Device
2. **VS Code:** Installiere "Draw.io Integration" Extension
3. **Desktop:** https://github.com/jgraph/drawio-desktop/releases
4. **PNG Export:** In draw.io → File → Export as PNG

Siehe auch: [`uml/README_DRAWIO.md`](UML/UML_Semester_2/README_DRAWIO.md)

### 12.2 Abhängigkeiten (requirements.txt)
...
│   ├── ARCHITEKTURDOKUMENTATION.md  # Diese Datei
│   ├── UML_DIAGRAMME.md        # Mermaid Diagramme
│   │
│   ├── uml/                    # draw.io Diagramme
│   │   ├── 01_component_diagram.drawio
│   │   ├── 02_sequence_login.drawio
│   │   ├── 03_sequence_trade.drawio
│   │   ├── 04_deployment_diagram.drawio
│   │   ├── 05_package_diagram.drawio
│   │   └── README_DRAWIO.md
│   │
│   ├── models/
│   │   ├── __init__.py
...
│   │   ├── portfolio_service.py# Portfolio Calculation
│   │   └── coin_sync_service.py# CoinGecko Synchronisation
│   │
│   ├── templates/
│   │   ├── base.html           # Base Template
│   │   ├── home.html           # Home Page
│   │   ├── dashboard.html      # All Coins View
│   │   ├── portfolio.html      # User Portfolio
│   │   ├── transactions.html   # Transaction History
│   │   ├── profile.html        # Login/Register
│   │   └── coin_detail.html    # Coin Details + Trade
│   │
│   └── static/
│       ├── style.css           # Styling
...
│
├── README.md
└── BLOG_AUFGABE2_ZUSAMMENFASSUNG.md
```
...
|---------|-------|-------|-----------|
| 1.0 | April 2026 | SE-Team | Initiale Dokumentation (Aufgabe 2, arc42) |
| 1.1 | April 2026 | SE-Team | draw.io Diagramme integriert |

---

**Dokument Ende**

*Diese Dokumentation wurde gemäß arc42-Template Version 9.0-DE erstellt.*

*Alle Diagramme sind als draw.io Dateien in `uml/` verfügbar.*
